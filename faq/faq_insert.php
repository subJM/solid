<?php
    ...
    if(isset($_POST["subject"]) && isset($_POST["content"])){
        ...
        if(!isset($_SESSION["userid"]) && !isset($_SESSION["username"]) && isset($_POST["parent"])){
            alert_back("회원만 사용 가능합니다.");
            exit;
        }else {
        ...
        if(isset($_POST["user_name"]) && isset($_POST["parent"]) && isset($_POST["user_id"])){
            // echo "아이디확인2 <br>" ;
            // 삽입하기전에 해당아이디가 있는지 점검
            $sql = "select * from faq_ripple where id = '$userid'";
            // echo " '$userid'" ;
            ...
            if(mysqli_num_rows($ripple_result) === 0){
                ...
                $sql .= " values('$parent', '$userid', '$name', '$content', '$regist_day')";
