...
<body>
            ...
            <ul id="board_list">
                ...
                for ($i = 0; $i < 10; $i++) { ?>
                    <li>
                        ...
                        <span class="col2_1"><a href="notice_view.php?.asdasd">코로나바이러스감염증-19 대응 집단시설.다중이용시설 소독 안내(제3-4판)</a></span>
                        <span class="col3">이성일</span>
                ...
                ?>
                    <li>
                        ...
                        ?>
                            <span class="col2_1" id="col2_1"><a href="question_view.php?num=<?= $row["num"] ?>&page=<?= $page ?>"><?= $subject ?></a>&nbsp;</span>
                        <?php } else { ?>
                            <input type="hidden" id="num" value="<?= $row["num"] ?>">
                            <span class="col2_1" id="col2_2" style="cursor: pointer;"><?= $subject ?>&nbsp;</span>
                        <?php } ?>
    ...
    <div id="popup">
        ...
        <div id="popup_btn">
            <h4>비밀번호 : </h4>
            <div>
                <input autocomplete="off" type="password" id="read_pw" maxlength="4" style="-webkit-text-security: disc;">
            </div>
