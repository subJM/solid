      ...
      <div id="member_form">
        <form name="member_form" id="input_member_form" method="post">
          ...
          <?php
                                ...
                                ?>
          <input autocomplete="off" type="text" name="id" id="input_id" value="<?= $userid ?>" readonly="readonly">
          <br>
          <p id="input_id_confirm"></p>
          ...
          <?php
                            if ($hidden_kakao_name) {
                                ?>
          <input autocomplete="off" type="text" name="name" id="input_name" value=<?= $hidden_kakao_name ?> readonly>
          <br>
          <?php
                            } else if ($mode) {
                                ?>
          ...
          <div id="phone">
            <div id="phone_input">
              ...
              -
              <input autocomplete="off" type="text" name="phone_two" id="phone_two" placeholder=" 0000 " maxlength="4"
                oninput="maxLengthCheck(this);">
              -
              <input autocomplete="off" type="text" name="phone_three" id="phone_three" placeholder=" 0000 "
            ...
            <div id="email">
              <div id="email_input">
                ...
                <?php
                                    ...
                                    ?>
                <input autocomplete="off" type="text" name="email_one" id="email_one" value="<?= $email1 ?>">
                @
                <input autocomplete="off" type="text" name="email_two" id="email_two" value="<?= $email2 ?>">
                <?php
                                    } else {
                                        ?>
                <input autocomplete="off" type="text" name="email_one" id="email_one" placeholder=" 이메일 입력 ">
                @
                <input autocomplete="off" type="text" name="email_two" id="email_two">
                <?php
                                    }
            ...
            <?php
                            if ($mode === "") {
                                ?>
            <div id="address">
              <input autocomplete="off" type="text" name="address_one" id="address_one" placeholder=" 우편번호 "
                onclick="address_input();">
              <input autocomplete="off" type="text" name="address_two" id="address_two" placeholder=" 주소 ">
              <input autocomplete="off" type="text" name="address_three" id="address_three" placeholder=" 상세주소 ">
              <br>
            ...
            <?php
                                ...
                                ?>
            <div id="address">
              <input autocomplete="off" type="text" name="address_one" id="address_one" value="<?= $address1 ?>"
                onclick="address_input();">
              <input autocomplete="off" type="text" name="address_two" id="address_two" value="<?= $address2 ?>"
                onclick="address_input();">
              <input autocomplete="off" type="text" name="address_three" id="address_three" value="<?= $address3 ?>">
              <br>
              <p id="input_address_confirm"></p>
            </div>
            <?php
            ...
            <div id="button">
              ...
              <?php
                                if ($mode === "") {
                                    ?>
              <div id="signup">
                <input type="submit" id="button_submit" value="가 입" onclick="action_signup()" disabled="true">
              </div>
              <?php
                                } else {
                                    ?>
              <div id="signup">
                <input type="button" id="button_submit" value="수정완료" onclick="action_update()" disabled="true">
              </div>
              <?php
                                }
                            ?>
